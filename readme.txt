...
ex. change the default to 999999, 100000 or higher. This should fix this for most themes.
...
* Add support for multiline HTML
* Custom CSS overide panel
* Documentation in options panel
